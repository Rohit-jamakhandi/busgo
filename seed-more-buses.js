...
Bus.insertMany(buses)
  .then(() => {
    console.log('✅ 20 Realistic buses added successfully!');
    console.log('\n📍 Routes covered:');
    console.log('- Mumbai ↔ Pune (3 buses each way)');
    console.log('- Bangalore ↔ Chennai (3 buses each way)');
    console.log('- Delhi → Agra (2 buses)');
    console.log('- Hyderabad → Bangalore (3 buses)');
    console.log('- Mumbai → Goa, Bangalore → Mysore, Delhi → Manali');
    console.log('- Jaipur → Delhi, Ahmedabad → Mumbai');
